...
class ConveyorSortingEnv(gym.Env):
    ...
    def __init__(self, render=False, use_robot=False):
        ...
        self.TUBE_URDF_PATHS = [
            r".\urdfs\polypropene-tube-1.urdf",
            r".\urdfs\polypropene-tube-2.urdf",
            r".\urdfs\polypropene-centrifugal-1.urdf",
            r".\urdfs\polypropene-centrifugal-2.urdf",
            r".\urdfs\lysis-tube-1.urdf"
        ]
        self.CONVEYOR_1_URDF = r".\urdfs\conveyor_belt_draft.urdf"
        ...
        self.BIN_URDF = ".\urdfs\bin.urdf"
        self.BIN_FUNNEL_URDF = ".\urdfs\bin_funnel.urdf"
        self.ur5_path = "./urdfs/ur5_robotiq_85.urdf"
